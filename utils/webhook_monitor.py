...
class WebhookMonitor:
    ...
    def get_status(self) -> Dict:
        ...
        return {
            ...
            "success_rate": (
                (self.check_count - self.failed_checks) / self.check_count * 100
...
class WebhookRecoveryManager:
    ...
    async def check_and_recover(self) -> bool:
        ...
        # Try to recover
        logger.warning(f"🔧 Attempting webhook recovery (attempt {self.recovery_attempts + 1}/{self.max_recovery_attempts})")
